...
import { Utensils, MapPin, Clock, Leaf, Sparkles, ChevronDown, Award } from 'lucide-react';
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-28 pb-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center">
        ...
        {/* Top Pure Veg Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-950/80 border border-emerald-500/40 text-emerald-300 text-xs font-bold uppercase tracking-widest backdrop-blur-md mb-6">
          <Leaf className="w-4 h-4 text-emerald-400" />
          100% Pure Vegetarian • Self Service
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-14">
          <Link
            href="/menu"
            className="w-full sm:w-auto px-8 py-4 rounded-full text-sm font-bold uppercase tracking-widest text-zinc-950 gold-gradient-bg shadow-xl shadow-amber-500/25 hover:shadow-amber-500/40 hover:scale-105 active:scale-95 transition flex items-center justify-center gap-2 group"
          >
          ...
          <Link
            href="/contact"
            className="w-full sm:w-auto px-8 py-4 rounded-full text-sm font-bold uppercase tracking-widest text-amber-200 bg-white/5 border border-amber-500/30 hover:bg-amber-500/10 hover:border-amber-500/50 backdrop-blur-md hover:scale-105 active:scale-95 transition flex items-center justify-center gap-2"
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl mx-auto">
          <div className="glass-card p-4 rounded-2xl flex items-center gap-3 text-left">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">Fresh & hygienic ingredients</p>
            </div>
          </div>
          ...
          <div className="glass-card p-4 rounded-2xl flex items-center gap-3 text-left">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400">Quick, friendly food service</p>
            </div>
          </div>
